...
public class HanWeatherDB {
	//数据库名
	public static final String DB_NAME="han_weather";
	//数据库版本
	public static final int VERSION=1;
	private static HanWeatherDB hanWeatherDB;
	private SQLiteDatabase db;
	//将构造方法私有化
	private HanWeatherDB(Context context){
		HanWeatherOpenHelper dbHelper=new HanWeatherOpenHelper(context,DB_NAME,null,VERSION);
	...
	public void saveCity(City city){
		if(city !=null){
			...
			values.put("city_code", city.getaCityCode());
